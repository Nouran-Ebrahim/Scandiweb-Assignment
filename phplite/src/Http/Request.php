...
class Request
{
    ...
    {
        //http://localhost/Scandiweb Junior Developer test/public/
    ...
    { //get the values (url)after base url (after public/) without query
    ...
    public static function get_fullurl()
    {
    ...
    /**
     *Check that request has the key
     *@param string $key
     *@param array $type
     * @return bool
     */
    ...
    public static function post($key)
    {
        ...
        /**
     * Set the value for request by given key
     *@param string $key
     *@param string $value
     * @return string $value
     */
